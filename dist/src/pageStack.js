...
class PageStack {
    ...
    createPage(node, state, link = true) {
        ...
        const pn = new PageNode((0, vue_1.cloneVNode)(node, { key: node.props?.key?.toString() + tag }), tag);
        if (link) {
    ...
    copyKeyProps(page, newNode) {
        return (0, vue_1.cloneVNode)(newNode, { key: page.node.key });
    }
    ...
    setRouteProps(node) {
        ...
        return (0, vue_1.cloneVNode)(node, { ...query });
    }
    getAction() {
