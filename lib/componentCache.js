  ...
  setup(props, ctx) {
    ...
    const vnodeActive = function(vnode, container, anchor, isSVG, optimized) {
      ...
      queuePostFlushCb(() => {
        ...
        if (vnodeHook) {
          callWithAsyncErrorHandling(vnodeHook, instance2.parent, 7, [
            vnode,
            null
          ]);
        }
    ...
    return function() {
      var _a, _b, _c, _d;
      const childNodes = (_b = (_a = ctx.slots) == null ? void 0 : _a.default) == null ? void 0 : _b.call(_a);
      ...
      if ((_c = newComponent.type.name) == null ? void 0 : _c.includes("Transition")) {
        ...
        if (isVNode(tarnsitionChildSlots)) {
          ...
          newComponent = (_d = tarnsitionChildSlots.default) == null ? void 0 : _d.call(tarnsitionChildSlots)[0];
          shouldOrvewriteChild = true;
          if (!newComponent) {
            return originChild;
          }
