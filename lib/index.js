...
exports.default = (0, vue_1.defineComponent)({
  ...
  setup(props, ctx) {
    const evaluator = props.componentEvaluator || new pageStack_1.default(props.lifeCycleCallback, props.router || (0, vue_router_1.useRouter)(), props.mergeQueryToProps);
